...
namespace WpfApp2
{
    public class Employé
    {
        ...
        public Employé(int cle_, string matricule, string nom, string prenom, string num_sec_social, DateTime date_naissance, string grade, DateTime date_prem, string etat, string ccp, string cle_ccp, string tel, string service, string email)
        {
            ...
            this.email = email;
            this.email = "im_aliousalah@esi.dz";
